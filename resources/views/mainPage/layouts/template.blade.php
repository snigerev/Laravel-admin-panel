...
<div id="app">
    ...
    <main class="py-4 d-flex">
        <div class="col-3 left-main">
            <img src="/images/mainPage/left_panel2.png" alt="">
        </div>
        <div class="col-6 d-flex justify-content-center">
            @yield('content')
        </div>
        <div class="col-3 right-main">
            <img src="/images/mainPage/right_panel2.png" alt="">
        </div>
    </main>
</div>
@yield('footer')
